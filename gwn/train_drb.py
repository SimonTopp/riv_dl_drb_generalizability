...
def train(data_in,
          adj_data,
          out_dir,
          x_vars=["seg_rain", "seg_tave_air", "seginc_swrad", "seg_shade", "seg_width", "seg_length", "seginc_potet", "seg_slope", "seg_humid", "seg_elev"],
          seq_length=60,
          out_dim=60,
          batch_size=20,
          epochs=50,
    ...
    engine = trainer(scaler, in_dim, num_nodes, nhid, dropout,
                         ...
                         adjinit, out_dim, kernel_size, n_blocks, layer_size)
    ...
    for i in range(1,epochs+1):
        ...
        torch.save(engine.model.state_dict(), out_dir+'/tmp/'+expid+"_epoch_"+str(i)+"_"+str(round(mvalid_loss,2))+".pth")
