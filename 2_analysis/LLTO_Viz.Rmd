...
pt_logs <- view_train_longs('../river-dl/results/baseline/GWN', pretrain=T) %>% mutate(model='GWN')%>%
  bind_rows(view_train_longs('../river-dl/results/baseline/RGCN', pretrain=T) %>% mutate(model='RGCN')) %>%
  group_by(model) %>%
